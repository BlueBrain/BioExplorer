...
inline std::unique_ptr<pdiff::RGBAImage> createPDiffRGBAImage(brayns::FrameBuffer& fb)
{
...
inline bool compareTestImage(const std::string& filename, brayns::FrameBuffer& fb,
                             const pdiff::PerceptualDiffParameters& parameters = pdiff::PerceptualDiffParameters())
{
...
#ifdef USE_NETWORKING
inline bool compareBase64TestImage(const brayns::ImageGenerator::ImageBase64& image, const std::string& filename)
{
