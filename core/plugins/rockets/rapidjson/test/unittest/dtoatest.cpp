...
#define TEST_DTOA(d, a)      \
    *dtoa(d, buffer) = '\0'; \
    ...
    TEST_DTOA(2.225073858507201e-308,
              "2.225073858507201e-308"); // Max subnormal positive double
    TEST_DTOA(2.2250738585072014e-308,
...
#define TEST_DTOA(m, d, a)      \
    *dtoa(d, buffer, m) = '\0'; \
    ...
    TEST_DTOA(3, 2.225073858507201e-308,
              "0.0"); // Max subnormal positive double
    TEST_DTOA(3, 2.2250738585072014e-308, "0.0"); // Min normal positive double
    TEST_DTOA(3, 1.7976931348623157e308,
