...
typedef struct
{
    ...
    MorphologyRepresentation morphologyRepresentation{MorphologyRepresentation::segment};
    /** Micro-domain representation */
    MicroDomainRepresentation microDomainRepresentation{MicroDomainRepresentation::mesh};
