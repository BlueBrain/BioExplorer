...
static constexpr double BIOEXPLORER_DEFAULT_RENDERER_DENSITY_RAY_STEP = 2.0;
static constexpr double BIOEXPLORER_DEFAULT_RENDERER_DENSITY_FAR_PLANE = 1000.0;
