...
class NeuronReportParams:
    ...
    def __init__(
        ...
        :param value_range: Vector2, optional: Range of values for the mapped data. Defaults to [-80.0, 10.].
        :param voltage_scaling_range: Vector2, optional: Minimum and maximum scaling factors. Defaults to [1., 1.0].
