...
public:
    ...
    bool Null() { return WriteStartElement("null", true); }

    bool Bool(bool b)
    {
        return WriteStartElement("boolean") &&
               WriteString(b ? "true" : "false") && WriteEndElement("boolean");
    }
    ...
    {
        return WriteStartElement("number") && WriteEscapedText(str, length) &&
               WriteEndElement("number");
    }

    bool String(const char* str, SizeType length, bool)
    {
        return WriteStartElement("string") && WriteEscapedText(str, length) &&
               WriteEndElement("string");
    }

    bool StartObject() { return WriteStartElement("object"); }
    ...
    bool EndObject(SizeType) { return WriteEndElement("object"); }

    bool StartArray() { return WriteStartElement("array"); }

    bool EndArray(SizeType) { return WriteEndElement("array"); }
...
private:
    ...
    bool WriteStartElement(const char* type, bool emptyElement = false)
    {
        ...
        {
            if (!WriteString(
                    " xsi:schemaLocation=\"http://www.datapower.com/schemas/"
                    "json jsonx.xsd\""
    ...
    {
        if (!WriteString("</json:") || !WriteString(type) || !WriteString(">"))
            return false;
