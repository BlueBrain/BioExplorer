...
int main(const int argc, char **const argv)
{
    try
    {
        ...
        const auto passed = pdiff::yee_compare(
            *args.image_a_, *args.image_b_, args.parameters_, nullptr,
            &error_sum, &reason, args.image_difference_.get(),
        ...
        if (args.sum_errors_)
        {
            const auto normalized =
                error_sum / (args.image_a_->get_width() *
        ...
        {
            args.image_difference_->write_to_file(
