...
GLFWbool _glfwInitVulkan(void)
{
    ...
    _glfw.vk.GetInstanceProcAddr =
        (PFN_vkGetInstanceProcAddr)_glfw_dlsym(_glfw.vk.handle,
    ...
    {
        _glfw.vk.extensions = _glfwPlatformGetRequiredInstanceExtensions(
            &_glfw.vk.extensionCount);
    }
                                         ...
                                         VkSurfaceKHR* surface)
{
    ...
    *surface = VK_NULL_HANDLE;
    ...
    return _glfwPlatformCreateWindowSurface(instance, window, allocator,
                                            surface);
}
