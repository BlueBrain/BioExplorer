...
typedef EGLBoolean(EGLAPIENTRY* PFNEGLGETCONFIGATTRIBPROC)(EGLDisplay,
                                                           EGLConfig, EGLint,
                                                           EGLint*);
typedef EGLBoolean(EGLAPIENTRY* PFNEGLGETCONFIGSPROC)(EGLDisplay, EGLConfig*,
                                                      EGLint, EGLint*);
...
typedef EGLBoolean(EGLAPIENTRY* PFNEGLINITIALIZEPROC)(EGLDisplay, EGLint*,
                                                      EGLint*);
...
typedef EGLContext(EGLAPIENTRY* PFNEGLCREATECONTEXTPROC)(EGLDisplay, EGLConfig,
                                                         EGLContext,
                                                         const EGLint*);
typedef EGLBoolean(EGLAPIENTRY* PFNEGLDESTROYSURFACEPROC)(EGLDisplay,
                                                          EGLSurface);
