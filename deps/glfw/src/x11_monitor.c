...
GLFWbool _glfwSetVideoModeX11(_GLFWmonitor* monitor, const GLFWvidmode* desired)
{
    if (_glfw.x11.randr.available && !_glfw.x11.randr.monitorBroken)
    {
        ...
        if (native)
        {
            ...
            XRRSetCrtcConfig(_glfw.x11.display, sr, monitor->x11.crtc,
                             CurrentTime, ci->x, ci->y, native, ci->rotation,
...
_GLFWmonitor** _glfwPlatformGetMonitors(int* count)
{
    ...
    *count = 0;
    ...
    if (_glfw.x11.randr.available)
    {
        ...
        RROutput primary =
            XRRGetOutputPrimary(_glfw.x11.display, _glfw.x11.root);
        ...
        {
            XRRCrtcInfo* ci =
                XRRGetCrtcInfo(_glfw.x11.display, sr, sr->crtcs[i]);
...
void _glfwPlatformGetGammaRamp(_GLFWmonitor* monitor, GLFWgammaramp* ramp)
{
    if (_glfw.x11.randr.available && !_glfw.x11.randr.gammaBroken)
    {
        ...
        XRRCrtcGamma* gamma =
            XRRGetCrtcGamma(_glfw.x11.display, monitor->x11.crtc);
