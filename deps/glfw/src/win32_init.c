...
static GLFWbool loadLibraries(void)
{
    ...
    _glfw.win32.winmm.timeGetTime =
        (TIMEGETTIME_T)GetProcAddress(_glfw.win32.winmm.instance,
                                      "timeGetTime");
    ...
    {
        _glfw.win32.dinput8.DirectInput8Create =
            (DIRECTINPUT8CREATE_T)GetProcAddress(_glfw.win32.dinput8.instance,
                                                 "DirectInput8Create");
    }

    {
        ...
        for (i = 0; names[i]; i++)
        {
            ...
            {
                _glfw.win32.xinput.XInputGetCapabilities =
                    (XINPUTGETCAPABILITIES_T)GetProcAddress(
    ...
    if (_glfw.win32.dwmapi.instance)
    {
        ...
        _glfw.win32.dwmapi.DwmFlush =
            (DWMFLUSH_T)GetProcAddress(_glfw.win32.dwmapi.instance, "DwmFlush");
    }
    ...
    if (_glfw.win32.shcore.instance)
    {
        _glfw.win32.shcore.SetProcessDpiAwareness = (SETPROCESSDPIAWARENESS_T)
            GetProcAddress(_glfw.win32.shcore.instance,
...
static HWND createHelperWindow(void)
{
    HWND window =
        CreateWindowExW(WS_EX_OVERLAPPEDWINDOW, _GLFW_WNDCLASSNAME,
                        ...
                        WS_CLIPSIBLINGS | WS_CLIPCHILDREN, 0, 0, 1, 1,
    ...
    // Register for HID device notifications
    {
        ...
        RegisterDeviceNotificationW(window, (DEV_BROADCAST_HDR*)&dbi,
