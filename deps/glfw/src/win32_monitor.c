                                   ...
                                   DISPLAY_DEVICEW* display)
{
    ...
    monitor = _glfwAllocMonitor(name, GetDeviceCaps(dc, HORZSIZE),
    ...
    if (display)
    {
        ...
        WideCharToMultiByte(CP_UTF8, 0, display->DeviceName, -1,
                            ...
                            sizeof(monitor->win32.publicDisplayName), NULL,
                            NULL);
    }
...
//
GLFWbool _glfwSetVideoModeWin32(_GLFWmonitor* monitor,
    ...
    for (adapterIndex = 0;; adapterIndex++)
    {
        ...
        if (hasDisplays)
        {
            for (displayIndex = 0;; displayIndex++)
            {
                ...
                if (!EnumDisplayDevicesW(adapter.DeviceName, displayIndex,
                                         &display, 0))
                    break;
