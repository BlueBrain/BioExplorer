...
#define GLFW_DONT_CARE -1
     ...
     * present, the `IDI_WINLOGO` icon will be used instead.  To set a different
     * icon, see
     ...
     *
     *  @remark @osx The GLFW window has no icon, as it is not a document
     *  window, so this function does nothing.  The dock icon will be the same
     * as the application bundle's icon.  For more information on bundles, see
     * the [Bundle Programming
     * Guide](https://developer.apple.com/library/mac/documentation/CoreFoundation/Conceptual/CFBundles/)
     *  in the Mac Developer Library.
     *
     *  @thread_safety This function must only be called from the main thread.
