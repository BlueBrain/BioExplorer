...
//  Read the FAQ about ImTextureID in imgui.cpp. [X] Platform: Clipboard support
//  (from Allegro 5.1.12) [X] Platform: Mouse cursor shape and visibility.
...
//  support for 32-bits vertex indices to avoid conversion at runtime. Added
...
#define ALLEGRO_HAS_CLIPBOARD \
    (ALLEGRO_VERSION_INT >=   \
     ((5 << 24) | (1 << 16) | (12 << 8))) // Clipboard only supported from
                                          // Allegro 5.1.12
...
void ImGui_ImplAllegro5_RenderDrawData(ImDrawData* draw_data)
{
    ...
    for (int n = 0; n < draw_data->CmdListsCount; n++)
    {
        ...
        // FIXME-OPT: Unfortunately Allegro doesn't support 32-bits packed
        // colors so we have to convert them to 4 float as well..
