                                  ...
                                  VkSurfaceKHR surface, int width, int height)
{
    ...
    ImGui_ImplVulkanH_CreateWindowDataCommandBuffers(g_PhysicalDevice, g_Device,
                                                     g_QueueFamily, wd,
                                                     g_Allocator);
...
static void FrameRender(ImGui_ImplVulkanH_WindowData* wd)
{
    ...
    VkSemaphore& image_acquired_semaphore =
        wd->Frames[wd->FrameIndex].ImageAcquiredSemaphore;
...
int main(int, char**)
{
    ...
    GLFWwindow* window =
        glfwCreateWindow(1280, 720, "Dear ImGui GLFW+Vulkan example", NULL,
                         NULL);
        ...
        if (show_another_window)
        {
            ImGui::Begin("Another Window",
                         &show_another_window); // Pass a pointer to our bool
                                                // variable (the window will
                                                // have a closing button that
                                                // will clear the bool when
                                                // clicked)
