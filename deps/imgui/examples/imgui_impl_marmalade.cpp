...
//  so they can be displayed in the About Window. 2018-02-16: Misc: Obsoleted
//  the io.RenderDrawListsFn callback and exposed
//  ImGui_Marmalade_RenderDrawData() in the .h file so you can call it yourself.
...
void ImGui_Marmalade_RenderDrawData(ImDrawData* draw_data)
{
    ...
    for (int n = 0; n < draw_data->CmdListsCount; n++)
    {
        ...
        {
            // TODO: optimize multiplication on gpu using vertex
        ...
        for (int cmd_i = 0; cmd_i < cmd_list->CmdBuffer.Size; cmd_i++)
        {
            ...
            else
            {
                ...
                IwGxDrawPrims(IW_GX_TRI_LIST, (uint16*)idx_buffer,
                              pcmd->ElemCount);
            }
...
bool ImGui_Marmalade_Init(bool install_callbacks)
{
    ...
    if (install_callbacks)
    {
        ...
        s3eKeyboardRegister(S3E_KEYBOARD_KEY_EVENT, ImGui_Marmalade_KeyCallback,
                            0);
...
void ImGui_Marmalade_NewFrame()
{
    ...
    io.MousePos =
        ImVec2((float)mouse_x / g_scale.x,
               (float)mouse_y / g_scale.y); // Mouse position (set to
                                            // -FLT_MAX,-FLT_MAX if no mouse /
