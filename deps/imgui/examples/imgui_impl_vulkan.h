...
IMGUI_IMPL_API void ImGui_ImplVulkanH_CreateWindowDataCommandBuffers(
...
IMGUI_IMPL_API void ImGui_ImplVulkanH_CreateWindowDataSwapChainAndFramebuffer(
...
struct ImGui_ImplVulkanH_FrameData
{
    uint32_t BackbufferIndex; // Keep track of recently rendered swapchain frame
                              // indices
