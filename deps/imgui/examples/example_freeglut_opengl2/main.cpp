// dear imgui: standalone example application for FreeGLUT + OpenGL2, using
// legacy fixed pipeline If you are new to dear imgui, see examples/README.txt
// and documentation at the top of imgui.cpp. (Using GLUT or FreeGLUT is not
...
int main(int argc, char** argv)
{
    ...
    // We will also call ImGui_ImplFreeGLUT_InstallFuncs() to get all the other
    // functions installed for us, otherwise it is possible to install our own
    // functions and call the imgui_impl_freeglut.h functions ourselves.
