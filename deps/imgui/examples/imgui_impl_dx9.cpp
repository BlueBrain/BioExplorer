...
void ImGui_ImplDX9_RenderDrawData(ImDrawData* draw_data)
{
    ...
    // draw_data->DisplayPos+data_data->DisplaySize (bottom right). Being
    // agnostic of whether <d3dx9.h> or <DirectXMath.h> can be used, we aren't
    ...
    for (int n = 0; n < draw_data->CmdListsCount; n++)
    {
        ...
        for (int cmd_i = 0; cmd_i < cmd_list->CmdBuffer.Size; cmd_i++)
        {
            ...
            {
                const RECT r = {(LONG)(pcmd->ClipRect.x - pos.x),
                ...
                g_pd3dDevice->DrawIndexedPrimitive(
                    D3DPT_TRIANGLELIST, vtx_offset, 0,
