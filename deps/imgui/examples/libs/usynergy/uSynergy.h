...
#define USYNERGY_MODIFIER_SCROLLOCK 0x4000  /* ScrollLock key modifier */
    ...
    **/
    typedef void (*uSynergyJoystickCallback)(uSynergyCookie cookie,
                                             uint8_t joyNum, uint16_t buttons,
                                             int8_t leftStickX,
                                             int8_t leftStickY,
                                             int8_t rightStickX,
                                             int8_t rightStickY);
    ...
    **/
    typedef void (*uSynergyClipboardCallback)(
        uSynergyCookie cookie, enum uSynergyClipboardFormat format,
    ...
    **/
    typedef struct
    {
        ...
        uSynergyCookie m_cookie; /* Cookie pointer passed to callback functions
                                    (can be NULL) */
        uSynergyTraceFunc m_traceFunc; /* Function for tracing status (can be
                                          NULL) */
        uSynergyScreenActiveCallback m_screenActiveCallback; /* Callback for
                                                                entering and
                                                                leaving screen
                                                              */
        uSynergyMouseCallback m_mouseCallback; /* Callback for mouse events */
        uSynergyKeyboardCallback m_keyboardCallback;   /* Callback for keyboard
                                                          events */
        uSynergyJoystickCallback m_joystickCallback;   /* Callback for joystick
                                                          events */
        uSynergyClipboardCallback m_clipboardCallback; /* Callback for clipboard
                                                          events */
        ...
        int8_t m_joystickSticks[USYNERGY_NUM_JOYSTICKS][4]; /* Joystick stick
                                                               position in 2
                                                               axes for 2 sticks
                                                             */
    ...
    **/
    extern void uSynergySendClipboard(uSynergyContext *context,
                                      const char *text);
