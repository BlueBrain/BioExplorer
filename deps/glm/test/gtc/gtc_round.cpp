...
int test_int32()
{
    ...
    for (std::size_t i = 0, n = sizeof(Data) / sizeof(type<int>); i < n; ++i)
    {
        ...
        Error +=
            glm::all(glm::equal(glm::bvec1(Data[i].Return), Result)) ? 0 : 1;
    }
    ...
    for (std::size_t i = 0, n = sizeof(Data) / sizeof(type<int>); i < n; ++i)
    {
        ...
        Error +=
            glm::all(glm::equal(glm::bvec2(Data[i].Return), Result)) ? 0 : 1;
    }
    ...
    for (std::size_t i = 0, n = sizeof(Data) / sizeof(type<int>); i < n; ++i)
    {
        ...
        Error +=
            glm::all(glm::equal(glm::bvec3(Data[i].Return), Result)) ? 0 : 1;
    }
    ...
    for (std::size_t i = 0, n = sizeof(Data) / sizeof(type<int>); i < n; ++i)
    {
        ...
        Error +=
            glm::all(glm::equal(glm::bvec4(Data[i].Return), Result)) ? 0 : 1;
    }
...
int test_float()
{
    ...
    for (std::size_t i = 0, n = sizeof(Data) / sizeof(type<glm::float64>);
         i < n; ++i)
    {
        glm::float64 Result =
            glm::floorMultiple(Data[i].Source, Data[i].Multiple);
        Error +=
            glm::epsilonEqual(Data[i].Return, Result, Data[i].Epsilon) ? 0 : 1;
    }
...
int test_float()
{
    ...
    {
        glm::float64 Result =
            glm::ceilMultiple(Data[i].Source, Data[i].Multiple);
        Error +=
            glm::epsilonEqual(Data[i].Return, Result, Data[i].Epsilon) ? 0 : 1;
    }
