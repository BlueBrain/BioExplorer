...
static int test_fvec_precision()
{
...

    {
        ...
        Error +=
            glm::all(glm::equal(v1, glm::f32vec2(v2), glm::epsilon<float>()))
                ? 0
                : 1;
        Error +=
            glm::all(glm::equal(v1, glm::f32vec2(v3), glm::epsilon<float>()))
                ? 0
                : 1;
        Error +=
            glm::all(glm::equal(v1, glm::f32vec2(v4), glm::epsilon<float>()))
                ? 0
                : 1;
    }

    {
        ...
        Error +=
            glm::all(glm::equal(v1, glm::f32vec3(v2), glm::epsilon<float>()))
                ? 0
                : 1;
        Error +=
            glm::all(glm::equal(v1, glm::f32vec3(v3), glm::epsilon<float>()))
                ? 0
                : 1;
        Error +=
            glm::all(glm::equal(v1, glm::f32vec3(v4), glm::epsilon<float>()))
                ? 0
                : 1;
    }

    {
        ...
        Error +=
            glm::all(glm::equal(v1, glm::f32vec4(v2), glm::epsilon<float>()))
                ? 0
                : 1;
        Error +=
            glm::all(glm::equal(v1, glm::f32vec4(v3), glm::epsilon<float>()))
                ? 0
                : 1;
        Error +=
            glm::all(glm::equal(v1, glm::f32vec4(v4), glm::epsilon<float>()))
                ? 0
                : 1;
    }
...
static int test_dvec_precision()
{
...

    {
        ...
        Error +=
            glm::all(glm::equal(v1, glm::f64vec2(v2), glm::epsilon<double>()))
                ? 0
                : 1;
        Error +=
            glm::all(glm::equal(v1, glm::f64vec2(v3), glm::epsilon<double>()))
                ? 0
                : 1;
        Error +=
            glm::all(glm::equal(v1, glm::f64vec2(v4), glm::epsilon<double>()))
                ? 0
                : 1;
    }

    {
        ...
        Error +=
            glm::all(glm::equal(v1, glm::f64vec3(v2), glm::epsilon<double>()))
                ? 0
                : 1;
        Error +=
            glm::all(glm::equal(v1, glm::f64vec3(v3), glm::epsilon<double>()))
                ? 0
                : 1;
        Error +=
            glm::all(glm::equal(v1, glm::f64vec3(v4), glm::epsilon<double>()))
                ? 0
                : 1;
    }

    {
        ...
        Error +=
            glm::all(glm::equal(v1, glm::f64vec4(v2), glm::epsilon<double>()))
                ? 0
                : 1;
        Error +=
            glm::all(glm::equal(v1, glm::f64vec4(v3), glm::epsilon<double>()))
                ? 0
                : 1;
        Error +=
            glm::all(glm::equal(v1, glm::f64vec4(v4), glm::epsilon<double>()))
                ? 0
                : 1;
    }
