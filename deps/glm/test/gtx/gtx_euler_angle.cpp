    ...
    return glm::all(glm::epsilonEqual(mat1[0], mat2[0], epsilon))
               ? (glm::all(glm::epsilonEqual(mat1[1], mat2[1], epsilon))
                      ? (glm::all(glm::epsilonEqual(mat1[2], mat2[2], epsilon))
                             ? (glm::all(glm::epsilonEqual(mat1[3], mat2[3],
                                                           epsilon))
                                    ? true
                                    : false)
                             : false)
         ...
         const glm::vec3& basis)
{
    ...
    testPairs.push_back(
        AngleAndAngleVelocity(zeroAngle, negativeAngleVelocity));
    ...
    testPairs.push_back(
        AngleAndAngleVelocity(negativeAngle, zeroAngleVelocity));
...
int test()
{
    ...
    glm::vec4 const V3 =
        glm::eulerAngleX(AngleX) * glm::eulerAngleY(AngleY) * V;
...
int test()
{
    ...
    glm::vec4 const V3 =
        glm::eulerAngleY(AngleY) * glm::eulerAngleX(AngleX) * V;
    Error += glm::all(glm::epsilonEqual(V1, V2, 0.00001f)) ? 0 : 1;
    Error += glm::all(glm::epsilonEqual(V1, V3, 0.00001f)) ? 0 : 1;
...
int test()
{
    ...
    glm::vec4 const V3 =
        glm::eulerAngleX(AngleX) * glm::eulerAngleZ(AngleZ) * V;
    Error += glm::all(glm::epsilonEqual(V1, V2, 0.00001f)) ? 0 : 1;
    Error += glm::all(glm::epsilonEqual(V1, V3, 0.00001f)) ? 0 : 1;
...
int test()
{
    ...
    glm::vec4 const V3 =
        glm::eulerAngleZ(AngleZ) * glm::eulerAngleX(AngleX) * V;
    Error += glm::all(glm::epsilonEqual(V1, V2, 0.00001f)) ? 0 : 1;
    Error += glm::all(glm::epsilonEqual(V1, V3, 0.00001f)) ? 0 : 1;
...
int test()
{
    ...
    glm::vec4 const V3 =
        glm::eulerAngleY(AngleY) * glm::eulerAngleZ(AngleZ) * V;
    Error += glm::all(glm::epsilonEqual(V1, V2, 0.00001f)) ? 0 : 1;
    Error += glm::all(glm::epsilonEqual(V1, V3, 0.00001f)) ? 0 : 1;
...
int test()
{
    ...
    glm::vec4 const V3 =
        glm::eulerAngleZ(AngleZ) * glm::eulerAngleY(AngleY) * V;
    Error += glm::all(glm::epsilonEqual(V1, V2, 0.00001f)) ? 0 : 1;
    Error += glm::all(glm::epsilonEqual(V1, V3, 0.00001f)) ? 0 : 1;
...
int test()
{
    ...
    std::printf("%s\n",
                glm::to_string(glm::fmat3(rotationEuler - (rotationInvertedY)))
                    .c_str());
...
int test(RotationFunc rotationFunc, TestExtractionFunc testExtractionFunc)
{
    ...
    for (size_t i = 0, size = testEulerAngles.size(); i < size; ++i)
    {
        ...
        testExtractionFunc(rotation, extractedEulerAngles.x,
                           extractedEulerAngles.y, extractedEulerAngles.z);
        glm::mat4 const extractedRotation =
            rotationFunc(extractedEulerAngles.x, extractedEulerAngles.y,
