...
static int test()
{
    ...
    {
        for (std::size_t i = 0;
             i < sizeof(TestBool) / sizeof(entry<float, bool>); ++i)
        {
            float Result =
                glm::mix(TestBool[i].x, TestBool[i].y, TestBool[i].a);
            Error +=
                glm::equal(Result, TestBool[i].Result, glm::epsilon<float>())
                    ? 0
                    : 1;
        }
    }
    ...
    {
        for (std::size_t i = 0;
             i < sizeof(TestFloat) / sizeof(entry<float, float>); ++i)
        {
            float Result =
                glm::mix(TestFloat[i].x, TestFloat[i].y, TestFloat[i].a);
            Error +=
                glm::equal(Result, TestFloat[i].Result, glm::epsilon<float>())
                    ? 0
                    : 1;
        }
    }
    ...
    // vec2 with bool
    {
        ...
        {
            glm::vec2 Result = glm::mix(TestVec2Bool[i].x, TestVec2Bool[i].y,
                                        TestVec2Bool[i].a);
            Error += glm::equal(Result.x, TestVec2Bool[i].Result.x,
                                glm::epsilon<float>())
                         ? 0
                         : 1;
            Error += glm::equal(Result.y, TestVec2Bool[i].Result.y,
                                glm::epsilon<float>())
                         ? 0
                         : 1;
        }
    ...
    // vec2 with bvec2
    {
             ...
             i < sizeof(TestBVec2) / sizeof(entry<glm::vec2, glm::bvec2>); ++i)
        {
            ...
            Error += glm::equal(Result.x, TestBVec2[i].Result.x,
                                glm::epsilon<float>())
                         ? 0
                         : 1;
            Error += glm::equal(Result.y, TestBVec2[i].Result.y,
                                glm::epsilon<float>())
                         ? 0
                         : 1;
        }
    ...
    // vec3 with bool
    {
        ...
        {
            glm::vec3 Result = glm::mix(TestVec3Bool[i].x, TestVec3Bool[i].y,
                                        TestVec3Bool[i].a);
            Error += glm::equal(Result.x, TestVec3Bool[i].Result.x,
                                glm::epsilon<float>())
                         ? 0
                         : 1;
            Error += glm::equal(Result.y, TestVec3Bool[i].Result.y,
                                glm::epsilon<float>())
                         ? 0
                         : 1;
            Error += glm::equal(Result.z, TestVec3Bool[i].Result.z,
                                glm::epsilon<float>())
                         ? 0
                         : 1;
        }
    ...
    // vec3 with bvec3
    {
             ...
             i < sizeof(TestBVec3) / sizeof(entry<glm::vec3, glm::bvec3>); ++i)
        {
            ...
            Error += glm::equal(Result.x, TestBVec3[i].Result.x,
                                glm::epsilon<float>())
                         ? 0
                         : 1;
            Error += glm::equal(Result.y, TestBVec3[i].Result.y,
                                glm::epsilon<float>())
                         ? 0
                         : 1;
            Error += glm::equal(Result.z, TestBVec3[i].Result.z,
                                glm::epsilon<float>())
                         ? 0
                         : 1;
        }
    ...
    // vec4 with bool
    {
        ...
        {
            glm::vec4 Result = glm::mix(TestVec4Bool[i].x, TestVec4Bool[i].y,
                                        TestVec4Bool[i].a);
            Error += glm::equal(Result.x, TestVec4Bool[i].Result.x,
                                glm::epsilon<float>())
                         ? 0
                         : 1;
            Error += glm::equal(Result.y, TestVec4Bool[i].Result.y,
                                glm::epsilon<float>())
                         ? 0
                         : 1;
            Error += glm::equal(Result.z, TestVec4Bool[i].Result.z,
                                glm::epsilon<float>())
                         ? 0
                         : 1;
            Error += glm::equal(Result.w, TestVec4Bool[i].Result.w,
                                glm::epsilon<float>())
                         ? 0
                         : 1;
        }
    ...
    // vec4 with bvec4
    {
             ...
             i < sizeof(TestBVec4) / sizeof(entry<glm::vec4, glm::bvec4>); ++i)
        {
            ...
            Error += glm::equal(Result.x, TestBVec4[i].Result.x,
                                glm::epsilon<float>())
                         ? 0
                         : 1;
            Error += glm::equal(Result.y, TestBVec4[i].Result.y,
                                glm::epsilon<float>())
                         ? 0
                         : 1;
            Error += glm::equal(Result.z, TestBVec4[i].Result.z,
                                glm::epsilon<float>())
                         ? 0
                         : 1;
            Error += glm::equal(Result.w, TestBVec4[i].Result.w,
                                glm::epsilon<float>())
                         ? 0
                         : 1;
        }
...
static int test()
{
    ...
    // vec4 and float
    {
        ...
        {
            glm::vec4 Result =
                glm::step(TestVec4Scalar[i].edge, TestVec4Scalar[i].x);
    ...
    // vec4 and vec4
    {
        ...
        {
            glm::vec4 Result =
                glm::step(TestVec4Vector[i].edge, TestVec4Vector[i].x);
...
static int test()
{
...

    {
        ...
        Error +=
            true == glm::any(glm::isinf(glm::dvec2(-1.0 / Zero_d))) ? 0 : 1;
        Error += true == glm::any(glm::isinf(glm::dvec3(1.0 / Zero_d))) ? 0 : 1;
        Error +=
            true == glm::any(glm::isinf(glm::dvec3(-1.0 / Zero_d))) ? 0 : 1;
        Error += true == glm::any(glm::isinf(glm::dvec4(1.0 / Zero_d))) ? 0 : 1;
        Error +=
            true == glm::any(glm::isinf(glm::dvec4(-1.0 / Zero_d))) ? 0 : 1;
    }

    {
        ...
        Error +=
            true == glm::any(glm::isinf(glm::vec2(-1.0f / Zero_f))) ? 0 : 1;
        Error += true == glm::any(glm::isinf(glm::vec3(1.0f / Zero_f))) ? 0 : 1;
        Error +=
            true == glm::any(glm::isinf(glm::vec3(-1.0f / Zero_f))) ? 0 : 1;
        Error += true == glm::any(glm::isinf(glm::vec4(1.0f / Zero_f))) ? 0 : 1;
        Error +=
            true == glm::any(glm::isinf(glm::vec4(-1.0f / Zero_f))) ? 0 : 1;
    }
...
#pragma warning(disable : 4146) // cast truncates constant value
    ...
    return -(static_cast<unsigned>(x) >> 31) |
           (-static_cast<unsigned>(x) >> 31);
...
int test_int32()
{
    type<glm::int32> const Data[] = {{std::numeric_limits<glm::int32>::max(),
                                      1},
                                     {std::numeric_limits<glm::int32>::min(),
                                      -1},
                                     {0, 0},
                                     {1, 1},
                                     {2, 1},
...
int test_i32vec4()
{
    type<glm::ivec4> const Data[] = {{glm::ivec4(1), glm::ivec4(1)},
...
int test_f32vec4()
{
    type<glm::vec4> const Data[] = {{glm::vec4(1), glm::vec4(1)},
    ...
    for (std::size_t i = 0; i < sizeof(Data) / sizeof(type<glm::vec4>); ++i)
    {
        ...
        Error +=
            glm::all(glm::equal(Data[i].Return, Result, glm::epsilon<float>()))
                ? 0
                : 1;
    }
...
static int test()
{
...

    {
        ...
        Error += glm::all(glm::equal(A, glm::vec1(0.5), glm::epsilon<float>()))
                     ? 0
                     : 1;
...
static int test()
{
...

    {
        ...
        Error +=
            glm::all(glm::equal(x, glm::vec2(1024, .24), 0.00001f)) ? 0 : 1;
    }

    {
        ...
        Error +=
            glm::all(glm::equal(x, glm::vec3(1024, .24, 0), 0.00001f)) ? 0 : 1;
    }

    {
        ...
        Error +=
            glm::all(glm::equal(x, glm::vec4(1024, .24, 0, -1.33), 0.00001f))
                ? 0
                : 1;
    }
