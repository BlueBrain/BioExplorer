...
int test()
{
    ...
    Error += glm::abs(Length1 - 1.0f) < std::numeric_limits<float>::epsilon()
                 ? 0
                 : 1;
    Error += glm::abs(Length2 - 1.0f) < std::numeric_limits<float>::epsilon()
                 ? 0
                 : 1;
    Error += glm::abs(Length3 - 1.0f) < std::numeric_limits<float>::epsilon()
                 ? 0
                 : 1;
    Error += glm::abs(Length4 - 1.0f) < std::numeric_limits<float>::epsilon()
                 ? 0
                 : 1;
...
int test()
{
    ...
    Error +=
        glm::abs(Distance1) < std::numeric_limits<float>::epsilon() ? 0 : 1;
    Error +=
        glm::abs(Distance2) < std::numeric_limits<float>::epsilon() ? 0 : 1;
    Error +=
        glm::abs(Distance3) < std::numeric_limits<float>::epsilon() ? 0 : 1;
    Error +=
        glm::abs(Distance4) < std::numeric_limits<float>::epsilon() ? 0 : 1;
...
int test()
{
    ...
    Error +=
        glm::all(
            glm::lessThan(glm::abs(Cross1 - glm::vec3(0, 0, 1)),
                          glm::vec3(std::numeric_limits<float>::epsilon())))
            ? 0
            : 1;
    Error +=
        glm::all(
            glm::lessThan(glm::abs(Cross2 - glm::vec3(0, 0, -1)),
                          glm::vec3(std::numeric_limits<float>::epsilon())))
            ? 0
            : 1;
...
int test()
{
    ...
    Error +=
        glm::all(
            glm::lessThan(glm::abs(Normalize1 - glm::vec3(1, 0, 0)),
                          glm::vec3(std::numeric_limits<float>::epsilon())))
            ? 0
            : 1;
    Error +=
        glm::all(
            glm::lessThan(glm::abs(Normalize2 - glm::vec3(1, 0, 0)),
                          glm::vec3(std::numeric_limits<float>::epsilon())))
            ? 0
            : 1;
