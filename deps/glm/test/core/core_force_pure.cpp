...
static int test_vec4_operators()
{
...

    {
        ...
        Error +=
            glm::all(glm::equal(C, glm::vec4(5, 7, 9, 11), 0.001f)) ? 0 : 1;
        ...
        glm::vec4 E = A * B;
        Error +=
            glm::all(glm::equal(E, glm::vec4(4, 10, 18, 28), 0.001f)) ? 0 : 1;
        ...
        glm::vec4 J = B / 2.0f;
        Error +=
            glm::all(glm::equal(J, glm::vec4(2, 2.5, 3, 3.5), 0.001f)) ? 0 : 1;
        ...
        glm::vec4 L = 1.0f - B;
        Error +=
            glm::all(glm::equal(L, glm::vec4(-3, -4, -5, -6), 0.001f)) ? 0 : 1;
