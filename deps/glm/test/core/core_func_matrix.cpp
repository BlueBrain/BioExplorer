...
int test_matrixCompMult()
{
...

    {
        ...
        for (length_t l = 0; l < m.length(); ++l)
            Error +=
                all(epsilonEqual(n[l], expected[l], epsilon<float>())) ? 0 : 1;
    }
...

    {
        ...
        mat4 expected = mat4(0, 1, 4, 9, 16, 25, 36, 49, 64, 81, 100, 121, 144,
                             169, 196, 225);
        for (length_t l = 0; l < m.length(); ++l)
            Error +=
                all(epsilonEqual(n[l], expected[l], epsilon<float>())) ? 0 : 1;
...
int test_transpose()
{
...

    {
        ...
        for (length_t l = 0; l < expected.length(); ++l)
            Error +=
                all(epsilonEqual(t[l], expected[l], epsilon<float>())) ? 0 : 1;
    }
...
int test_inverse()
{
...

    {
        ...
        for (length_t l = 0; l < Identity.length(); ++l)
            Error += all(epsilonEqual(I4x4[l], Identity[l], epsilon<float>()))
                         ? 0
                         : 1;
    }

    {
        ...
        for (length_t l = 0; l < Identity.length(); ++l)
            Error += all(epsilonEqual(I3x3[l], Identity[l], epsilon<float>()))
                         ? 0
                         : 1;
    }

    {
        ...
        for (length_t l = 0; l < Identity.length(); ++l)
            Error += all(epsilonEqual(I2x2[l], Identity[l], epsilon<float>()))
                         ? 0
                         : 1;
    }
