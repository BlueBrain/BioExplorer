...
static int test_vec3_operators()
{
...

    {
        ...
        Error +=
            glm::all(glm::equal(C, glm::vec3(5, 7, 9), glm::epsilon<float>()))
                ? 0
                : 1;

        glm::vec3 const D = B - A;
        Error +=
            glm::all(glm::equal(D, glm::vec3(3, 3, 3), glm::epsilon<float>()))
                ? 0
                : 1;
        ...
        Error +=
            glm::all(glm::equal(G, glm::vec3(2, 3, 4), glm::epsilon<float>()))
                ? 0
                : 1;

        glm::vec3 const H = B - 1.0f;
        Error +=
            glm::all(glm::equal(H, glm::vec3(3, 4, 5), glm::epsilon<float>()))
                ? 0
                : 1;

        glm::vec3 const I = A * 2.0f;
        Error +=
            glm::all(glm::equal(I, glm::vec3(2, 4, 6), glm::epsilon<float>()))
                ? 0
                : 1;
        ...
        Error +=
            glm::all(glm::equal(K, glm::vec3(2, 3, 4), glm::epsilon<float>()))
                ? 0
                : 1;

        glm::vec3 const L = 1.0f - B;
        Error += glm::all(glm::equal(L, glm::vec3(-3, -4, -5),
                                     glm::epsilon<float>()))
                     ? 0
                     : 1;
        ...
        Error +=
            glm::all(glm::equal(M, glm::vec3(2, 4, 6), glm::epsilon<float>()))
                ? 0
                : 1;
