...
static __device__ __inline__ float intersectPlane(const float3& origin,
...
static __device__ __inline__ float3 offset(const float3& hit_point,
                                           const float3& normal)
{
...
static __device__ __inline__ void refine_and_offset_hitpoint(
    ...
    const float3& normal, const float3& p, float3& back_hit_point,
