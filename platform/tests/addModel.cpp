...
TEST_CASE_FIXTURE(ClientServer, "nonexistant_file")
{
    try
    {
        makeRequest<core::ModelParams, core::ModelDescriptor>(
...
TEST_CASE_FIXTURE(ClientServer, "xyz")
{
    ...
    CHECK_NOTHROW((makeRequest<core::ModelParams, core::ModelDescriptor>(
...
TEST_CASE_FIXTURE(ClientServer, "protein_loader")
{
    ...
    core::ModelParams params{"1mbs", BRAYNS_TESTDATA_MODEL_PDB_PATH,
                               properties};
...
TEST_CASE_FIXTURE(ClientServer, "cancel")
{
    auto request = getJsonRpcClient()
                       .request<core::ModelParams, core::ModelDescriptor>(
...
{
    CHECK_THROWS_AS(
        (makeRequest<core::ModelParams, core::ModelDescriptorPtr>(
