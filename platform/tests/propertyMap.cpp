...
TEST_CASE("set_property_from_other_property")
{
    ...
    core::PropertyMap otherProperties;
...
TEST_CASE("merge_enums")
{
    ...
    core::PropertyMap propStrings;
    propStrings.setProperty({"abc", std::string("c"), enums, {}});

    {
        core::PropertyMap propIntsTmp;
    ...
    {
        core::PropertyMap propStringsTmp;
