...
void TestTranscode(const char* json)
{
    ...
    Writer<GenericStringBuffer<TargetEncoding>, UTF8<>, TargetEncoding> writer(
        buffer);
    Reader reader;
...
TEST(Writer, Transcode)
{
    const char json[] =
        "{\"hello\":\"world\",\"t\":true,\"f\":false,\"n\":null,\"i\":123,"
        "\"pi\":3.1416,\"a\":[1,2,3],\"dollar\":\"\x24\",\"cents\":"
        "\"\xC2\xA2\",\"euro\":\"\xE2\x82\xAC\",\"gclef\":"
        "\"\xF0\x9D\x84\x9E\"}";
...
TEST(Writer, OStreamWrapper)
{
    StringStream s(
        "{ \"hello\" : \"world\", \"t\" : true , \"f\" : false, \"n\": null, "
        "\"i\":123, \"pi\": 3.1416, \"a\":[1, 2, 3], \"u64\": "
        "1234567890123456789, \"i64\":-1234567890123456789 } ");
    ...
    EXPECT_STREQ(
        "{\"hello\":\"world\",\"t\":true,\"f\":false,\"n\":null,\"i\":123,"
        "\"pi\":3.1416,\"a\":[1,2,3],\"u64\":1234567890123456789,\"i64\":-"
        "1234567890123456789}",
        actual.c_str());
}
...
{
    // Fail in decoding invalid UTF-8 sequence
    ...
    // Fail in encoding
    {
        ...
        static const UTF32<>::Ch s[] = {0x110000,
                                        0}; // Out of U+0000 to U+10FFFF
...
{
    {
        ...
        writer.EndArray();
        EXPECT_STREQ(
            "[\"\x24\",\"\xC2\xA2\",\"\xE2\x82\xAC\",\"\xF0\x9D\x84\x9E\","
            "\"\\u0001\",\"\\u001B\"]",
            buffer.GetString());
    }
